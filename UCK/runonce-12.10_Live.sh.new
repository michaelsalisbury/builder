#!/bin/builder.sh
skip=( true true true false true false false false false false false false false false true false true true true true true true true true true true true true true true true true false true true true false false false false false false false )
step=1
prefix="setup"
...
function get_nmcli_con_detail(){
	...
	nmcli -t --fields NAME con list				|\
		xargs -i@ cmcli -t --fields all con list id @   |\
...
END-OF-WIREDCONNECTION
	...
	sed -f "/^INTERFACES=/cINTERFACES=\"${LAN}\"" /etc/default/isc-dhcp-server
