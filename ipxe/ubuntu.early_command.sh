...
main(){
	...
	chroot_profile_d ${pass_env_to_live} aliases.sh alias rdesktop='rdesktop -d cos -T Win7-x86_64 -k en-us -r clipboard:PRIMARYCLIPBOARD -r sound=local -x 0x81 -z -N -a 32'
	chroot_profile_d ${pass_env_to_live} aliases.sh alias rdesktop.DLPBMM1-VB.hd='rdesktop   10.173.119.78 -u mi164210 -g 1980x1020 &'
	chroot_profile_d ${pass_env_to_live} aliases.sh alias rdesktop.DLPBMM1-VB.ld='rdesktop   10.173.119.78 -u mi164210 -g 1333x768 &'
	chroot_profile_d ${pass_env_to_live} aliases.sh alias rdesktop.DLPBMM1-VB.xga='rdesktop  10.173.119.78 -u mi164210 -g 1024x768 &'
	chroot_profile_d ${pass_env_to_live} aliases.sh alias rdesktop.DLPBMM1-VB.sxga='rdesktop 10.173.119.78 -u mi164210 -g 1280x1024 &'
