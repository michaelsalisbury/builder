...
sourceI="${HOME}/ubuntu-12.10-xfce4-amd64.iso"
liveISO="${HOME}/ubuntu-12.10-xfce4-1-amd64.iso"
isoDesc="01234567890123456789012345678901"
isoDesc="Ubuntu 12.10+ x64 XFCE4-1"
workDir="${HOME}/uck-xfce4-1"
...
function setup_Repack_initrd(){
	desc Repack initrd
	sudo uck-remaster-pack-initrd "${workDir}"
}
function setup_Repack_rootfs(){
	desc Repack rootfs
	sudo uck-remaster-pack-rootfs "${workDir}"
}
function setup_Repack_ISO(){
	desc Repack ISO
	sudo uck-remaster-pack-iso "${liveISO}" "${workDir}" -d "${isoDesc}"
